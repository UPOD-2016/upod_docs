...
SirTrevor.Blocks.Equation = (function(){
	...
	var block_data = {equation: null, label: null}
	...
	paste_options: {
      ...
      html: "<input type=\"text\" class=\"st-paste-block st-label-paste\" placeholder='Equation Label'>"
	...
	addMath: function(elem, equation){
		...
		QUEUE.Push(
			function(){ $(elem).html(math_script); },
			function() { $(elem).css("visibility","hidden"); },
			["Typeset",MathJax.Hub,elem],
			function(){ $(elem).css("visibility","visible"); }
		);
