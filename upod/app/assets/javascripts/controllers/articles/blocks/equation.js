...
$(document).on('turbolinks:load', function() {
		...
		var VariableInputField = function(container){
			...
			var deleteCallbacks = [];
			var self = this;
			var input_template = "<div class='variable_input'><input type='text' name='variable' placeholder='Variable (Asciimath)'> = <input type='text' name='description' placeholder='Variable Description'><button type='button'>Remove</button></div>";
        ...
        return SirTrevor.Block.extend({
			...
			addVariable: function(variable, description){		
				...
				var variable_preveiw_el = $('<p/>', {
					...
					'change': function(){ 
						//May need to manually invoke .change() whenever equation changes to have mathjax typeset it again
				...
				//Can now add it to the DOM
				variable_preveiw_el.appendTo(variable_preview);
				
				//Called whenever the user changes the notation/description of this variable
				variable_field.addUpdateCallback(function(){
					...
					//global variable array is updated because it holds a reference to this var_obj
